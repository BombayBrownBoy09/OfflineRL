...
from .torch.edac_impl import EDACImpl
...
class EDAC(AlgoBase):
    ...
    def __init__(
        ...
        *,
        ...
        gradient_variance_weight: float = 1.0,
        use_gpu: UseGPUArg = False,
        scaler: ScalerArg = None,
        action_scaler: ActionScalerArg = None,
        reward_scaler: RewardScalerArg = None,
        impl: Optional[EDACImpl] = None,
        **kwargs: Any
    ):
        super().__init__(
    ...
    def _create_impl(
        ...
        self._impl = EDACImpl(
            ...
            gradient_variance_weight=self._gradient_variance_weight,
