...
from d3rlpy.algos.torch.edac_impl import EDACImpl
...
@pytest.mark.parametrize("gradient_variance_weight", [1.0])
...
def test_edac_impl(
    ...
    impl = EDACImpl(
        ...
        gradient_variance_weight=gradient_variance_weight,
        use_gpu=None,
        scaler=scaler,
